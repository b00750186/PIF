...
void build_model_CPIF_SN(instance* inst);
void build_model_CPIF_NZ(instance* inst);
//void build_model_CPIF_NN(instance* inst);

void solve_model_CPIF(instance* inst);
void solve_model_CPIF_anno(instance* inst);
void solve_model_CPIF_SN(instance* inst);
void solve_model_CPIF_NZ(instance* inst);
//void solve_model_CPIF_NN(instance* inst);
